...
resource "aws_s3_object" "mongodb" {
  ...
  source = "./uploads/msk/connect/plugins/mongo-kafka-connect-1.7.0-all.jar"
}
...
resource "aws_s3_object" "datagen" {
  ...
  source = "./uploads/msk/connect/plugins/confluentinc-kafka-connect-datagen-0.5.3.zip"
}
...
resource "aws_s3_object" "snowflake" {
  ...
  source = "./uploads/msk/connect/plugins/snowflake-kafka-connector-1.8.0.zip"
}
