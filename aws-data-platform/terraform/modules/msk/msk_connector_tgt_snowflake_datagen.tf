...
resource "aws_mskconnect_connector" "tgt_snowflake_datagen" {
  ...
  connector_configuration = {
    ...
    "snowflake.private.key"            = "$${secretManager:/msk/connect/dev_entechlog_snowflake:private_key}",
    "snowflake.private.key.passphrase" = "$${secretManager:/msk/connect/dev_entechlog_snowflake:private_key_passphrase}",
